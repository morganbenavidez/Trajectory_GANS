...
class Trajectory_Dataloader():
    ...
    def traject_preprocess(self, setname):
        ...
        for seti, directory in enumerate(data_dirs):
            ...
            print('abspath: ', os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'data', 'eth', 'hotel', 'true_pos_.csv')))
            file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'data', 'eth', 'hotel', 'true_pos_.csv'))
    ...
    def find_trajectory_fragment(self, trajectory, startframe, seq_length, skip):
        ...
        try:
            ...
            return_trajec[offset_start:offset_start + candidate_seq.shape[0], :3] = candidate_seq
